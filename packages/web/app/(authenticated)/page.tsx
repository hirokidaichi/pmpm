  ...
  return (
    <div className="px-6 pb-20 pt-6">
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-8">
        {/* Header */}
        <header className="glass-strong animate-fade-up rounded-none p-6">
            ...
            <CardContent className="space-y-3">
              {[
                ...
                <Link key={item.href} href={item.href}>
                  <div className="flex items-center gap-4 rounded-none border border-white/10 bg-white/5 p-4 transition hover:border-white/20 hover:bg-white/10">
